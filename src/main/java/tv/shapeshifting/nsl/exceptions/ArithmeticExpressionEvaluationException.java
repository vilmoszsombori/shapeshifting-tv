...
public class ArithmeticExpressionEvaluationException extends Exception {

	private static final long serialVersionUID = -342772626492620408L;
	...
	public ArithmeticExpressionEvaluationException(final int id, final String str) {
		row_ = -1;
		col_ = -1;
		id_ = id;
	 ...
	 * @PARAM id id of the message
	 */
	public ArithmeticExpressionEvaluationException(final int id) {
		row_ = -1;
		col_ = -1;
		id_ = id;
	 ...
	 * @PARAM str a string which will be filled in in the message
	 */
	public ArithmeticExpressionEvaluationException(final int row, final int col, final int id, final String str) {
		row_ = row;
		col_ = col;
		id_ = id;
	 ...
	 * @PARAM id id of the message
	 */
	public ArithmeticExpressionEvaluationException(final int row, final int col, final int id) {
		row_ = row;
		col_ = col;
		id_ = id;
