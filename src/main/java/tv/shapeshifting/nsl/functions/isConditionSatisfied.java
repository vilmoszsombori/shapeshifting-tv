...
public class isConditionSatisfied extends FunctionBase1 {
	private static Logger LOG = Logger.getLogger(isConditionSatisfied.class);

	public isConditionSatisfied() {
		super();
	}
