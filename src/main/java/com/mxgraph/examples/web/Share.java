...
public class Share extends HttpServlet
{
	...
	protected static mxSharedState sharedResource = (useSharedModel) ? new mxSharedGraphModel(
			new mxGraphModel()
			{
				private static final long serialVersionUID = 131226176338876940L;
			...
			HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (query.equalsIgnoreCase("start")) {
			response.sendRedirect("a/editors/diagrameditor.html");
			...
			mxXmlUtils.parseXml(sharedResource.getState());
			LOG.debug("yey");
